...
window.addEventListener('load', ()=>{                   // Una vez que se carga la página pone el canvas con esas dimensiones
    ...
    class Game {
        ...
        draw(context) {
            ...
            if (!this.gameStart) {            // Inicio
                context.font = 'bold 25px Helvetica'
                context.fillStyle = "black"
                context.textAlign = 'center'
                // this.image = document.querySelector('#default')
        ...
        add_platforms(lowerY, upperY) {     // Selecciona aleatoriamente plataforma entre los tipos actuales -- Agregar plataformas nuevas -- 
            do {
                let type = 'green'
       ...
       add_broken_platforms(lowerY, upperY) {
        ...
        change_difficulty() {   
                                // A mayor (menor) es la altura sube de nivel pone menos plataformas y más enemigos
            this.level++
